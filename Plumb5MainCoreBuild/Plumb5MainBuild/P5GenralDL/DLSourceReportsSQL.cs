...
{
    public class DLSourceReportsSQL : CommonDataBaseInteraction, IDLSourceReports
    {
        CommonInfo connection;
        public DLSourceReportsSQL(int adsId)
        {
            connection = GetDBConnection(adsId);
        }

        public DLSourceReportsSQL(string connectionString)
        {
        ...
        {
            string storeProcCommand = "Lms_Source_Report";
