...
{
    public class DLMailTemplateAttachmentPG : CommonDataBaseInteraction, IDLMailTemplateAttachment
    {
        CommonInfo connection = null;
        public DLMailTemplateAttachmentPG(int adsId)
        {
            connection = GetDBConnection(adsId);
        }

        public DLMailTemplateAttachmentPG(string connectionString)
        {
        ...
        public  List<MailTemplateAttachment> GetAttachments(int MailTemplateId)
        {
            ...
            using var db = GetDbConnection(connection.Connection);
            return (db.Query<MailTemplateAttachment>(storeProcCommand, param)).ToList();
        }
