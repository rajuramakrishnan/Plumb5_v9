...
{
    public class DLMobileVisitorPreInformationPG : CommonDataBaseInteraction, IDLMobileVisitorPreInformation
    {
        CommonInfo connection;
        public DLMobileVisitorPreInformationPG(int adsId)
        {
            connection = GetDBConnection(adsId);
        }

        public DLMobileVisitorPreInformationPG(string connectionString)
        {
        ...
        public byte OnlineSentimentIs(string EmailId)
        {
            if (!String.IsNullOrEmpty(EmailId))
            {
                string storeProcCommand = "formrules_engauageandq5_onlinesentimentis";
                List<string> paramName = new List<string> { "@_emailid" };
                object[] objDat = { EmailId };
        ...
        public byte SocialStatusIs(int ContactId)
        {
            if (ContactId > 0)
            {
                string storeProcCommand = "formrules_engauageandq5_socialstatus";
                List<string> paramName = new List<string> { "@_emailid" };
                object[] objDat = { ContactId };
        ...
        public short InfluentialScore(int ContactId)
        {
            if (ContactId > 0)
            {
                string storeProcCommand = "formrules_engauageandq5_influentialscore";
                List<string> paramName = new List<string> { "@_emailid" };
                object[] objDat = { ContactId };
        ...
        public short NurtureStatusIs(int ContactId)
        {
            if (ContactId > 0)
            {
                string storeProcCommand = "forms_sp_allformsloading_nurturestatusis";
                List<string> paramName = new List<string> { "@_contactid" };
                object[] objDat = { ContactId };
        ...
        public string GetGenderValue(int ContactId)
        {
            if (ContactId > 0)
            {
                string storeProcCommand = "formrules_engauageandq5_gender";
                List<string> paramName = new List<string> { "@_contactid" };
                object[] objDat = { ContactId };
        ...
        public byte ConnectedSocially(int ContactId)
        {
            if (ContactId > 0)
            {
                string storeProcCommand = "formrules_engauageandq5_connectedsocially";
                List<string> paramName = new List<string> { "@_contactid" };
                object[] objDat = { ContactId };
                using (IDbCommand Command = GetCommand(connection, storeProcCommand, paramName, objDat))
                {
        ...
        public short LoyaltyPoints(int ContactId)
        {
            if (ContactId > 0)
            {
                string storeProcCommand = "formrules_engauageandq5_loyaltypoints";
                List<string> paramName = new List<string> { "@_contactid" };
                object[] objDat = { ContactId };
